...
export const startStoreVariablesScrape = '/// Program/Terms';
export const endStoreVariablesScrape = '</script>';
export const varDefine = 'var';
export const arrayDefine = 'new Array(';
...
export const courseMaterialHTML = await axiosRequest(
...
export function getCourseMaterialVariables(courseMaterialHTML: string) {
