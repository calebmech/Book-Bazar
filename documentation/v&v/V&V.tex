...
\hline
M6T2 & Unauthenticated HTTP GET request to /api/user & HTTP NO\_CONTENT response & HTTP NO\_CONTENT response & Pass \\
\hline
...
\hline
M6T4 & Unauthenticated HTTP GET request to /api/user/:id & HTTP UNAUTHORIZED response & HTTP UNAUTHORIZED response & Pass \\
\hline
...
\hline
M6T6 & Unauthenticated HTTP PUT request to /api/user/:id containing user update & HTTP UNAUTHORIZED response & HTTP UNAUTHORIZED response & Pass \\
\hline
...
\hline
M6T10 & Unauthenticated HTTP DELETE request to /api/user/:id & HTTP UNAUTHORIZED response & HTTP UNAUTHORIZED response & Pass \\
\hline
\end{tabular}
\end{table}
